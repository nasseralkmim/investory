...
python -m investory.values --commodity ^spx --yahooticker ^spx --output-dir data --begin 2022-12-01
python -m investory.reports --ledger all.ledger --data-dir data --verbose 0 --currency $
#+end_src
