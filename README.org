...
2. Automatically fetch missing prices from Yahoo Finance
3. Cache prices to the data directory
4. Generate comprehensive reports including ROI analysis
...
Price data is now managed automatically by the reports module.
The old manual method using =investory.values= is shown below for reference,
but is no longer necessary:

#+begin_src sh :dir examples/reports-1/data
# Legacy method (not required anymore)
# python -m investory.values --commodity aapl --begin 2023-01-01
# head aapl.ledger

# New method (automatic)
# Just run reports - prices are fetched automatically
python -m investory.reports --ledger all.ledger --data-dir data --currency $ -v 1
#+end_src
...
+=======++============+============++===============+==========+=============+=========++=========++============+==========+
|     1 || 2023-01-01 | 2023-01-31 ||             0 |  $125.07 |     $142.44 |  $17.37 || 414.09% ||     13.89% |  362.46% |
|     2 || 2023-02-01 | 2023-02-28 ||       $142.44 |        0 |     $145.75 |   $3.30 ||  34.82% ||      2.32% |   34.85% |
|     3 || 2023-03-01 | 2023-03-31 ||       $145.75 |        0 |     $163.04 |  $17.29 || 274.39% ||     11.86% |  274.20% |
|     4 || 2023-04-01 | 2023-04-30 ||       $163.04 |        0 |     $167.77 |   $4.73 ||  41.58% ||      2.90% |   41.60% |
|     5 || 2023-05-01 | 2023-05-31 ||       $167.77 |        0 |     $175.49 |   $7.73 ||  69.92% ||      4.61% |   70.00% |
|     6 || 2023-06-01 | 2023-06-30 ||       $175.49 |        0 |     $192.05 |  $16.55 || 199.44% ||      9.43% |  199.34% |
|     7 || 2023-07-01 | 2023-07-31 ||       $192.05 |        0 |     $194.50 |   $2.46 ||  16.14% ||      1.28% |   16.15% |
|     8 || 2023-08-01 | 2023-08-31 ||       $194.50 |        0 |     $186.26 |  $-8.24 || -39.95% ||     -4.24% |  -39.96% |
|     9 || 2023-09-01 | 2023-09-30 ||       $186.26 |        0 |     $169.74 | $-16.52 || -67.69% ||     -8.87% |  -67.70% |
|    10 || 2023-10-01 | 2023-10-31 ||       $169.74 |        0 |     $169.31 |  $-0.44 ||  -2.98% ||     -0.26% |   -3.02% |
|    11 || 2023-11-01 | 2023-11-30 ||       $169.31 |        0 |     $188.57 |  $19.26 || 271.02% ||     11.38% |  271.10% |
|    12 || 2023-12-01 | 2023-12-31 ||       $188.57 |        0 |     $191.13 |   $2.56 ||  17.22% ||      1.36% |   17.24% |
+-------++------------+------------++---------------+----------+-------------+---------++---------++------------+----------+
| Total || 2023-01-01 | 2023-12-31 ||             0 |  $125.07 |     $191.13 |  $66.06 ||  53.18% ||     52.82% |   52.82% |
+-------++------------+------------++---------------+----------+-------------+---------++---------++------------+----------+

#+end_example

We can see that in one month, the stock went from $125.07 to $142.44.
An unrealized profit of $17.56.
A 13.89% growth in one month (/ (- 142.44 125.07) 125.07).
...
# New simplified workflow - automatic price fetching
python -m investory.reports \
    --ledger all.ledger \
    --data-dir data \
    --currency € \
    --benchmark-ticker ^spx ^bvsp ^ndx \
    -v 1
#+end_src
