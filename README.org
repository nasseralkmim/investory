...
#+begin_src sh :async yes :session reports-elaborate :results silent
python -m investory.values --commodity VWCE --yahooticker vwce.de --output-dir data --begin 2021-01-01 --currency €
python -m investory.values --commodity SP500 --yahooticker ^spx --output-dir data --begin 2021-01-01 --currency $
